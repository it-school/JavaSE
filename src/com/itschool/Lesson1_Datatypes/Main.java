package com.itschool.Lesson1_Datatypes;

import java.util.Scanner;

/**
 * Main - Главный класс для этого пакета
 */
public class Main {
    /**
    ...
    private static void example_3() {
        // В Java для констант принято писать идентификаторы большими буквами
        final int ONE_GIGABYTE = 1_073_741_824;
        final long ONE_TERABYTE = 1_099_511_627_776L;
    ...
    private static void example_6() {
        ...
        // Для декремента всё происходит аналогично
    }

    /**
     * Math - класс для работы с математическими функциями
     */
    private static void example_7() {
        ...
        System.out.println(Math.round(9.5 - 0.00000000000001)); // выведет 9
        System.out.println(Math.ceil(9.4)); // выведет 10.0
        System.out.println(Math.floor(9.4)); // выведет 9.0
